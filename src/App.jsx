...
import slide1 from "./assets/images/layout/slide1.webp";
import slide2 from "./assets/images/layout/slide2.webp";
...
function App() {
  ...
  return (
    <>
      <section
        id="main"
        className="relative h-screen overflow-x-hidden bg-cover overflow-y-auto flex items-center justify-center scroll-anim"
        style={{
      ...
      >
        ...
        <div className="relative app-container grid grid-cols-1 lg:grid-cols-2 border-3 border-white rounded-4xl overflow-hidden">
          <div className="flex flex-col gap-4 p-10">
            <h1 className="text-white leading-none text-left">TAL</h1>
            <SwiperSlider items={slides} />
          </div>

          <div className="relative pl-10 pr-2 pt-10 pb-10 flex flex-col gap-7 text-white">
            ...
            <div className="relative z-10 flex flex-col gap-7">
              ...
              <div className="flex flex-col gap-5 pr-10">
                ...
                <div className="text-white">
                  تمرکز من روی ساخت UI های مدرن، سبک و کاربرمحور است
                </div>
              </div>
              <div className="flex justify-end gap-3">
                <button className="text-lg bg-[var(--brand-primary)] hover:bg-[#799c02] px-5 py-4 rounded-2xl cursor-pointer">
                  تماس بگیرید
                </button>
              </div>
